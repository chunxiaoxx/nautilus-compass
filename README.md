...
| **LongMemEval-S e2e 500q full** (doubao subject × glm judge, 2026-08-29) | **42.6%** (213/500) by type: ssu **95.7%** · ssp **80.0%** · ku **73.1%** · ssa 25.0% · ms 22.6% · tr 15.8% (was **0%** — date-anchor fix) | honest two-tier: single-session near ceiling; cross-session aggregation (ms/ssa/tr) is the public next lever (answer spread over 3+ sessions exceeds 3-utterance context). 30q paired run: 56.7% (+30pt context fix, small-sample). Full JSON: [`docs/evidence/e2e_500_full_20260829.json`](docs/evidence/e2e_500_full_20260829.json) |
| **LongMemEval-V2 small tier** (451q first baseline, untuned · 2026-08-30) | **web 19.6% / enterprise 12.8%** (26.8% / 17.4% among answered) | brand-new multi-session benchmark; first untuned numbers published as-is. The loss is retrieval, not the reader: unknown-rate is 43–54% of answered questions (procedure-type 52.4% shows the design carries over); multi-session retrieval adaptation is the public next lever. Evidence: [`vtf/_compass_lmev2_out/`](vtf/_compass_lmev2_out/) |
