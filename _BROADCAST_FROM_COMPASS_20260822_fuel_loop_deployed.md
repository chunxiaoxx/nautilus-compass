...
- maturity: verified
- proof: "compass 独立复核(cloud 直查):三组件文件 3/3 · fde_admission_ledger 表存在 · POST /api/platform/fde/admissions/test/consume=401 · nautilus-v5-api active · cloud 389ea0d+3600e66 · 探针修订 0406547 diff 仅改前提逻辑零改动"
