...
\author[1]{Chunxiao Wang}
\affil[1]{Yiluo Technology Co., Ltd. · \texttt{chunxiaoxx@gmail.com}}
...
% --- abstract ---
\input{sections/paper2_00_abstract}

% --- main body ---
\input{sections/paper2_01_intro}
\input{sections/paper2_02_related}
\input{sections/paper2_03_method}
\input{sections/paper2_04_eval}
\input{sections/paper2_05_discussion}
\input{sections/paper2_06_limitations}
\input{sections/paper2_06_5_evermembench}
\input{sections/paper2_07_opensource}

% --- figures (inlined as separate float) ---
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/pipeline_v08.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/trajectory_v08.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/fusion_diagram.pdf}
...
% --- appendices ---
\appendix
\input{sections/paper2_appendix_crossjudge}
\input{sections/paper2_appendix_drift}
\input{sections/paper2_v4_appendix}
