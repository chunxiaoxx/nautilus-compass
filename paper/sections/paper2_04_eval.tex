% Paper 2 · §4 Experiments
% Status: draft · 2026-05-05 · v0.8 final 数据
...
\begin{tabular}{lrrrr}
\toprule
\textbf{Type} & \textbf{n} & \textbf{Baseline} & \textbf{v0.8} & \textbf{\(\Delta\)} \\
\midrule
single-session-assistant & 56 & 76.8\% & \textbf{83.9\%} & +7.1 \\
knowledge-update & 78 & 51.3\% & \textbf{57.7\%} & +6.4 \\
single-session-user & 70 & 30.0\% & \textbf{57.1\%} & \textbf{+27.1} \\
multi-session & 133 & 43.6\% & 54.9\% & +11.3 \\
single-session-preference & 30 & 33.3\% & 53.3\% & +20.0 \\
temporal-reasoning & 133 & 45.9\% & 46.6\% & +0.7 \\
\midrule
\textbf{Overall} & 500 & 46.6\% & \textbf{56.6\%} & \textbf{+10.0} \\
\bottomrule
\end{tabular}
...
\;\;+ TOP\_K 10 \(\to\) 15 & 50.0\% (\(+0\)) \\
\;\;+ ssa context 2400 \(\to\) 3500 & 50.5\% (\(+0.5\)) \\
\;\;+ multi-session decompose prompt & 53.0\% (\(+2.5\)) \\
\;\;+ knowledge-update timestamp prompt & 54.0\% (\(+1.0\)) \\
\;\;+ multi-angle query rewriting (ssu only) & \textbf{56.2\%} (\(+2.2\)) \\
\midrule
