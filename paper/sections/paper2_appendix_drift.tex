...
% Status: draft 	extperiodcentered{}  2026-05-05 	extperiodcentered{}  详细补充 §3.A 章节
...
\begin{quote}\itshape
  ``ssh cloud 	extperiodcentered{}  看 PG \texttt{agent\_wallets} 余额轨迹 	extperiodcentered{}  不靠推测''
\end{quote}

Example negative anchor (engineering domain):
\begin{quote}\itshape
  ``跑 verify 命令看实际输出 	extperiodcentered{}  没看到 OK 不说完成'' \emph{(positive)}\\
  ``声称完成但未验证 	extperiodcentered{}  没看实际输出就说 OK'' \emph{(negative 	extperiodcentered{}  same surface form)}
\end{quote}
