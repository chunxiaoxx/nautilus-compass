% Paper 2 	extperiodcentered{}  Appendix C 	extperiodcentered{}  DeepSeek V4 preliminary results
% Status: 2026-05-05 	extperiodcentered{}  sample 48 FINAL 	extperiodcentered{}  60.4% 	extperiodcentered{}  HOLD full 500 ([Chinese comment] max_tokens [Chinese comment])
...
with V3.2 (\(-0.2\) pts overall 	extperiodcentered{}  within noise). Per-type, V4 wins
...
Based on sample 48 results (60.4\% 	extperiodcentered{}  +4.2 vs v0.8 sample 56.2\%),
we \textbf{do not} run V4-pro full 500 in current configuration. Reasons:

\begin{itemize}
\item Improvement (+4.2 pts) is below our \textbf{\(\ge\)3 pt
...
\item The 9 pt drop on ssa supports the \texttt{reasoning\_content}
  truncation hypothesis 	extperiodcentered{}  before retrying, set
...
\item V4-pro \texttt{think-high} + \texttt{max\_tokens=16384} sample 48
  (\$2 	extperiodcentered{}  1h) 	extperiodcentered{}  check if ssa returns to 75--80\% and temporal to ~46\%.
\item If yes, run V4-pro full 500 with the new max\_tokens (\$14 	extperiodcentered{}  8h).
\item V4-pro \texttt{think-max} on sample 48 (\$3 	extperiodcentered{}  1.5h) 	extperiodcentered{}  may push ku/ssu
