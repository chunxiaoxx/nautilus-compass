...
\url{https://github.com/chunxiaoxx/zenmind-mem}. The repository
...
\begin{verbatim}
git clone https://github.com/chunxiaoxx/zenmind-mem
cd zenmind-mem
...
zenmind-mem is developed in the context of running production AI
