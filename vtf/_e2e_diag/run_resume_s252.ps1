# Resume s252 remaining questions 327-336 (shard died silently at 327)
...
Start-Process -NoNewWindow -FilePath cmd -ArgumentList '/c', "$setChain python -u tests/eval_longmemeval_accuracy.py --pipeline=m3-only --full --start 327 --end 336 > vtf/_e2e_diag/arm_a_s252_resume.log 2>&1"
Write-Output "RESUME_LAUNCHED"
