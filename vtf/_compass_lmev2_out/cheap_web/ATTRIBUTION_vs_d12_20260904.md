...
4. **延迟面同样净伤**:memory_query p50 **8.011s** / p95 9.515s / max 7312s(n=240,
   max=首题冷启动全库懒索引)。对照 d12 现役 web p50 0.165s / p95 0.339s——**p50 慢 ~48×**
   (a11y_chars 1500 大块+query_decomp 多子查询 RRF 的查询期开销)。亚秒 memory_query 是
   现役核心卖点,此面失守与精度面同向。
