...
SERVER_VERSION = "3.1.2"  # 2026-09-02 四处版本一次对齐(pyproject/package.json/plugin.json/server,此前 3.0.1/3.1.0/2.3.0 三轨漂移);3.1.1 = test+security+stability 专项(mcp_durable 契约迁移+漏网客户端#8+watchdog v3)
