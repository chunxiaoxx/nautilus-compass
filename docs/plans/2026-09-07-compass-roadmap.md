...
### 2.0 总纲:仲裁栈设计图纸(2026-09-07 补)

②层仲裁器产品化的完整设计见 [2026-09-07-arbitration-stack-design.md](2026-09-07-arbitration-stack-design.md):
五层栈(L0 原语/L1 判据语言/L2 验证方网络/L3 回执链/L4 结算声誉)×七算子仲裁化映射
(核心:**忘=共识函数**——衰减从时间函数升级为共识函数)×三 Phase;
对外叙事红线:**PKI 式信任最小化**,不称区块链式去信任。
