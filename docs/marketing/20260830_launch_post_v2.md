...
> ⛔ **已废弃(2026-09-05)——禁止发布**:本稿停留在 42.6% 旧口径(分型数字也是摘要层上线前的旧值)。
> 现行版 = [20260904_launch_post_v3.md](20260904_launch_post_v3.md)(75.4/81.6 双口径定案)。
> 保留本文件仅作历史追溯,防误发加横幅。
...
> 🔴 发布动作需用户拍板(对外发布纪律)。
> ⏸️ 发布状态(8/31 用户拍板):内容就绪,**等 d14(刀4)/s250 测试结果出来后刷新数字再发**。发布前刷新清单:
> - [x] d14 刀4:未过门(2026-09-02 定案——误拒答 92/89 越界,路线关闭)→ 维持 d12 现役
> - [x] d12 基线重判版出数(2026-09-02):干净口径 web 40.0% / ent 38.4%(污染版 36.7/40.3 作废);README 已换,主帖正文无 LME-V2 数字(数字在 LME-V2 骨架帖,已同步)
> - [ ] s250 重跑完成 → e2e 42.6% 段核对(0.567 为 glm-5.3-flash judge 口径,若换 doubao judge 需注明差异)
> - [ ] 终检:帖子数字与 README/落地页三处一致
